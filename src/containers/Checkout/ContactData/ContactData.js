...
class ContactData extends Component {
   ...
   orderHandler = event => {
      ...
      const order = {
         ...
         orderData: formData,
         userId: this.props.locaUserId,
      }

      this.props.onOrderBurger(order, this.props.localToken)
   }
   ...
   render() {
      return (
         <div className={classes.ContactData}>
            ...
            {this.props.localLoading ? <Spinner /> : this.renderForm()}
         </div>
      )
   }
}
